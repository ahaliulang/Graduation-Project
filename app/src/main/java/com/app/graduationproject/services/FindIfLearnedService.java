...
public class FindIfLearnedService extends IntentService{
    ...
    private static final String TAG = "FindIfLearnedService";

    public static final String ACTION_CODE = "com.app.graduationproject.findiflearnedService.action_code";
    public static final String EXTRA_CODE = "learn";

    public FindIfLearnedService() {
        super(TAG);
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            Boolean body = CloudAPIService.getInstance().findIfLearned(studentCode, courseCode).execute().body();
            sendResult(body);
