...
public class BaseActivity extends AppCompatActivity implements  BGASwipeBackHelper.Delegate{
    ...
    private void initSwipeBackFinish(){
        ...
        //必须在Application的onCreate 方法中执行BGASwipeBackManager.getInstance().init(this)来初始化返回
        //下面几项可以不配置，这里只是为了讲述接口使用方法
    ...
    /**
     * 是否支持滑动返回。这里在父类中默认返回true来支持滑动返回，
     * 如果某个页面不想支持滑动返回则重写该方法返回false即可
     * @return
     */
    @Override
